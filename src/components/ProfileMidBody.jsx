...
export default function ProfileMidBody() {
    ...
    const fetchPosts = (userId) => {
        fetch(
            `https://2cf6d4c3-9d6f-4642-b93f-f9c30c6ef031-00-2798gdwv0yhvq.pike.replit.dev/posts/user/${userId}`
        )
    ...
    return (
        <Col sm={6} className="bg-light" style={{ border: "1px solid lightgrey" }}>
            ...
            <p className="mt-3" style={{ margin: 0, fontWeight: "bold", fontSize: "15px" }}>
                Haris
            </p>
